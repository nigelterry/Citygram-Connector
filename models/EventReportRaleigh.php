...
/*			'properties.lcr_desc' => '',
	...
	public function modelIndexAttributes(){
		return [
			...
			[ 'attribute' => 'datetime.sec', 'format' => 'datetime', 'label' => 'Event Date / Time' ],
			'id' => '',
			'dataset' => '',
			[ 'attribute' => 'datetime.sec', 'format' => 'date', 'label' => 'Event Date / Time' ],
    ...
    public function popupContent()
    {
        $properties = (object)$this->properties;
        return Html::tag('div',
            'Crime incident #' . $properties->objectid .
        date(' D M j \a\t g:ia',
            $this->datetime->sec) .
        '. Raleigh Police described as ' .
        (isset($properties->event_name) ? $properties->event_name : 'undefined'),['class' => 'popup-body']) .
        $this->linkBlock();
    }
