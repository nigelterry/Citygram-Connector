 ...
 */
class PoliceReportC extends PoliceReport
{
    /**
     * @inheritdoc
     */
    ...
    {
        return ['citygram', 'police_report_cary'];
    }

    public function __construct()
    {
        parent::__construct();
        $this->config->urlName = 'police-report-c';
        $this->config->dataset = 'Police Report Cary';
        $this->config->title = 'Cary Police Report';
    }
