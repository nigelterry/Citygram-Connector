 ...
 */
class PermitReportR extends PermitReport
{
    ...
    {
        return ['citygram', 'permit_report_raleigh'];
    }

    public function __construct()
    {
        parent::__construct();
        $this->config->urlName = 'permit-report-r';
        $this->config->dataset = 'Raleigh Permit Application';
        $this->config->title = 'Raleigh Permit Application';
